...
const List = () => {
  ...
  async function onDelete() {
    ...
    try {
      await api.delete(`/equipamento-manutencaos/${deleteData.id}`, {});
      ...
      <Table
        ...
        columns={
          <>
            ...
            <TableCell className={classesTable.cell}>Saída</TableCell>
            <TableCell className={classesTable.cell}>Retorno</TableCell>
        ...
        {data.map((row) => {
          return (
            <TableRow key={row.id} hover className={classesTable.row}>
              ...
              <TableCell>{row.retornoFormat}</TableCell>
